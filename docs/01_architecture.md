...
public class ApiError {
   ...
   ...
```
В `ApiError` также применена аннотация `@JsonInclude(JsonInclude.Include.NON_NULL)` на поле validationErrors, 
...
!!! note "Примечание"
    ...
    операции будут либо выполнены полностью, либо произойдёт откат операций при возникновении ошибки.
